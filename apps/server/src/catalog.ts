...
/**
 * Skills = as ferramentas que o Claude Code realmente usa, agrupadas por
 * natureza. Não é enfeite: é o que ele está fazendo naquele segundo.
 */
export const SKILLS: Skill[] = [
  { id: 'read',   name: 'Leitura',    detail: 'READ · GLOB · GREP',   initials: 'RD', color: '#38bdf8', inUse: false },
  { id: 'edit',   name: 'Edição',     detail: 'EDIT · WRITE',         initials: 'ED', color: '#22d3ee', inUse: false },
  { id: 'shell',  name: 'Shell',      detail: 'BASH · POWERSHELL',    initials: 'SH', color: '#fbbf24', inUse: false },
  { id: 'web',    name: 'Web',        detail: 'SEARCH · FETCH',       initials: 'WB', color: '#a855f7', inUse: false },
  { id: 'task',   name: 'Subagente',  detail: 'TASK · DELEGAÇÃO',     initials: 'TK', color: '#f472b6', inUse: false },
  { id: 'notes',  name: 'Plano',      detail: 'TODO · NOTAS',         initials: 'PL', color: '#34d399', inUse: false },
  { id: 'other',  name: 'Outras',     detail: 'DEMAIS FERRAMENTAS',   initials: 'OT', color: '#94a3b8', inUse: false },
];
...
export function describeTool(tool: string, input: Record<string, unknown>): string {
  ...
  switch (tool) {
    ...
    case 'Task': return `Delegando para ${String(input.subagent_type ?? 'subagente')}`;
